...
int main(int argc, char *argv[])
{
	...
	*/
	...
	setting.setFixedStepsize(0.0005, order); // order = 4/5
	...
	Interval init_x0(30), init_x1(1.4), init_x2(100 - 20 * w, 100 + 20 * w), init_x3(10.5 - w, 10.5 + w), init_x4(32.025 - 0.05 * w, 32.025 + 0.05 * w), init_x5(30.025 - 0.05 * w, 30.025 + 0.05 * w), init_x6(0), init_x7(0);
